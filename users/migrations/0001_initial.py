...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'is_active'], name='users_membe_user_id_f11754_idx'), models.Index(fields=['organization', 'is_active'], name='users_membe_organiz_b7a6a9_idx')],
            },
        ),
